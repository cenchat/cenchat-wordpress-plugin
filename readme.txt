...
Cenchat is a plugin for websites where it reinvents how your audiences can have a conversation with you—the author.

People are only allowed to send private messages to you so the public (and mostly toxic) conversations can happen elsewhere. As an author, you can then publicize those conversations as read-only so the insightful ones can stand out.
...
We support all modern browsers. Internet Explorer isn't one of them.
